...
const  TopText = (props) => {
  ...
  return (
    <div className="TopTextContainer">
        <CampaignPicker campaign = {props.campaign} setCampaign = {(camp)=>props.setCampaign(camp)}/>
        {props.campaign === "Shipping" ? <Shipping emptyText = {props.emptyText}
                                                   free = {props.free}
                                          ...
                                          /> : <Announcment  products = {props.products}
