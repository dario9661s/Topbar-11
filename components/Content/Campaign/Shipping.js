...
const Shipping = (props) => {
  ...
  const sendText = () => {
    axios
      .put(
        `https://dejri-123.loca.lt/campaign/shipping?empty=${props.shipping.emptyText}&after=${props.shipping.moreAfter}&before=${props.shipping.moreBefore}&freeShipping=${props.shipping.free}`
      )
      .then((res) => res);
  };
