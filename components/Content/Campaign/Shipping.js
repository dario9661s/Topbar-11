...
const Shipping = (props) => {
  ...
  return (
    <FormLayout>
      {props.activeCampaign === "Shipping" ? (
        <TextStyle variation="positive">Active</TextStyle>
      ) : null}
      <TextField
        label="Empty cart Text"
        onFocus={() =>
          props.setShipping({ ...props.shipping, shippingFocused: "empty" })
        }
        value={props.shipping.emptyText}
        onChange={(value) =>
          props.setShipping({ ...props.shipping, emptyText: value })
        }
        type="text"
      ...
      <FormLayout.Group>
        <TextField
          ...
          onFocus={() =>
            props.setShipping({ ...props.shipping, shippingFocused: "more" })
          }
          value={props.shipping.moreBefore}
          onChange={(value) =>
            props.setShipping({ ...props.shipping, moreBefore: value })
          }
          type="text"
        ...
        <TextField
          ...
          onChange={(value) =>
            props.setShipping({ ...props.shipping, moreAfter: value })
          }
          type="text"
      ...
      <TextField
        ...
        onFocus={() =>
          props.setShipping({ ...props.shipping, shippingFocused: "free" })
        }
        value={props.shipping.free}
        onChange={(value) =>
          props.setShipping({ ...props.shipping, free: value })
        }
        type="text"
