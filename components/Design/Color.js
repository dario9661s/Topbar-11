    ...
    axios
      .put(
        `https://massive-frog-5.loca.lt/design/design?color=${props.colorBack.hex.replace(
          ...
          props.design.value
        }&fontcolor=${props.color.hex.replace("#", "")}&italic=${
          props.design.italic
        }`
      )
        ...
        <Card title="Design" sectioned>
          <Stack vertical>
            ...
            <LetterSpacing
              ...
              setDesign={(color) => props.setDesign(color)}
            />
            <Button onClick={() => changeColor()} fullWidth primary>
              Save Design
            </Button>
          </Stack>
        </Card>
            ...
            <Stack vertical>
              ...
              <Stack vertical>
                ...
                <ButtonGroup fullWidth segmented={true}>
                  <Button
                    pressed={picker === "our" ? true : false}
                    onClick={() => setPicker("our")}
                  >
                    Font
                  </Button>
                  <Button
                    pressed={picker === "custom" ? true : false}
